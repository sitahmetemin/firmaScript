...
<head>
    ...
    <link href="/backend/assets/global/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" />
    <link href="/backend/assets/global/css/plugins-md.min.css" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="/backend/assets/pages/css/login-2.min.css" rel="stylesheet" type="text/css" />
...
<div class="logo">
    <a href="index.html">
        <img src="/baackend/assets/pages/img/logo-big-white.png" style="height: 17px;" alt="" /> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    ...
    <form class="login-form" method="post">
        ...
        <div class="form-title">
            <span class="form-title">Hoşgeldiniz, Lütfen Giriş Yapın.</span>
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Mail Adresiniz" name="email" /> </div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Şifre</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Şifreniz" name="password" /> </div>
        <div class="form-actions">
            <button type="submit" class="btn red btn-block uppercase">Giriş Yap</button>
        </div>
        <div class="form-actions">
            <div class="pull-left">
    ...
    <form class="forget-form" method="post">
        <div class="form-title">
            ...
            <span class="form-subtitle">Mail adrenizi girin. Sizin için Şifrenizi Sıfırlayalım.</span>
        </div>
        <div class="form-group">
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary uppercase pull-right">Gönder</button>
        </div>
    </form>
    <!-- END FORGOT PASSWORD FORM -->
</div>
<div class="copyright"> 2017 © BeeCorp Yazılım. </div>
<!-- END LOGIN -->
<!--[if lt IE 9]>
