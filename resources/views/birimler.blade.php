            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Firma Birimleri</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <label class="btn btn-transparent grey-salsa btn-outline btn-circle btn-sm">
                                <a href="/birimler/ekle-birim" class="toggle"><i class="fa fa-plus"></i>&nbsp;Ekle</a>
                            </label>
                        </div>
                        <div class="btn-group">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($cekilenBirimler as $birim)
                                <tr>
                                    ...
                                    <td>
                                        <a href="/birimler/guncelle-birim/{{ $birim->id }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>&nbsp;/ &nbsp;
                                        <a href="/birimler/sil-birim/{{ $birim->id }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
