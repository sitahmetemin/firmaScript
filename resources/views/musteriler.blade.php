        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-black-tie font-green"></i>
                        <span class="caption-subject font-green sbold uppercase">Müşteriler</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <label class="btn btn-transparent grey-salsa btn-outline btn-circle btn-sm">
                                <a href="/musteriler/ekle-musteri" class="toggle"><i class="fa fa-plus"></i>&nbsp;Ekle</a>
                            </label>
                        </div>
                        <div class="btn-group">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($cekilenMusteriler as $musteri)
                                <tr>
                                    ...
                                    <td> {{ $musteri->email }}</td>
                                    <td> {{ $musteri->il }}</td>
                                    <td> {{ $musteri->yetkili->name }}</td>
                                    <td> {{ $musteri->updated_at }}</td>
                                    <td>
                                        <a href="/musteriler/guncelle-musteri/{{ $musteri->id }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>&nbsp;/ &nbsp;
                                        <a href="/musteriler/sil-musteri/{{ $musteri->id }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
