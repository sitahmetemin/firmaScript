            ...
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Talep Güncelle</span>
                    </div>
                </div>
                    ...
                    <form method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input name="aciklama" class="form-control" id="mask_date" value="{{ $bulunanTalep->aciklama }}" required type="text"/>
                                                ...
                                                <select name="birim_id" id="single" class="form-control select2">
                                                    ...
                                                    <optgroup label="Ürün Birimleri">
                                                        @foreach($cekilenBirimler as $birim)
                                                            @if($birim->id == $bulunanTalep->birim_id )
