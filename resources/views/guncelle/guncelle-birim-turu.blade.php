            ...
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Birim Türü Güncelle</span>
                    </div>
                </div>
                    ...
                    <form method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="ad" class="form-control" id="mask_date" required type="text" value="{{ $bulunanBirimTuru->ad }}"/>
