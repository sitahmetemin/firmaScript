            ...
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Müşteri Güncelle</span>
                    </div>
                </div>
                    ...
                    <form method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="unvan" class="form-control" id="mask_date" required type="text" value="{{ $bulunanMusteri->unvan }}"/>
                                        ...
                                        <select name="yetkili_id" class="form-control select2">
                                            ...
                                            <optgroup label="Firma Yetkilisi">
                                                @foreach($cekilenYetkililer as $yetkili)
                                                    @if($yetkili->id == $bulunanMusteri->yetkili_id)
                                                        <option selected value="{{ $yetkili->id }}"> {{ $yetkili->name }}</option>
                                                    @else
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="telefon" class="form-control" id="mask_date" type="number" value="{{ $bulunanMusteri->telefon }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="email" class="form-control" id="mask_date" required type="email" value="{{ $bulunanMusteri->email }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="adres" class="form-control" id="mask_date" required type="text" value="{{ $bulunanMusteri->adres }}"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input name="il" class="form-control" id="mask_date" required type="text" value="{{ $bulunanMusteri->il }}"/>
