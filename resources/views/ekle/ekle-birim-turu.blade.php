            ...
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Birim Türü Ekle</span>
                    </div>
                </div>
                    ...
                    <form method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">Birim Türü</label>
                                <div class="col-md-4">
                                    <input name="ad" class="form-control" id="mask_date" required type="text" />
                                    <span class="help-block"> Birim Türünü Yazınız </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Birim Türleri</span>
                        @if(session('status'))
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            <tbody>
                            @foreach($cekilenBirimTurleri as $tur)
                                <tr>
                                    <td> {{$tur->id}}</td>
                                    <td> {{ $tur->ad }}</td>
                                    <td> {{ $tur->updated_at }}</td>
                                    <td>
                                        <a href="/ekle-birim-turu/guncelle-birim-turu/{{ $tur->id }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>&nbsp;/ &nbsp;
                                        <a href="/ekle-birim-turu/sil-birimTuru/{{ $tur->id }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
