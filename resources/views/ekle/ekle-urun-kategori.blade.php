            ...
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Ürün Kategorisi Ekle</span>
                    </div>
                </div>
                    ...
                    <form method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">Ürün Kategorisi</label>
                                <div class="col-md-4">
                                    <input name="ad" class="form-control" id="mask_date" required type="text"/>
                                    <span class="help-block"> Ürün Kategorisi Yazınız </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Ürün Kategorileri</span>
                        @if(session('status'))
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            <tbody>
                            @foreach($urunKategorileri as $urunKategorisi)
                                <tr>
                                    <td> {{$urunKategorisi->id}}</td>
                                    <td> {{ $urunKategorisi->ad }}</td>
                                    <td> {{ $urunKategorisi->updated_at }}</td>
                                    <td>
                                        <a href="/ekle-urun-kategori/guncelle-urun-kategori/{{ $urunKategorisi->id }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>&nbsp;/ &nbsp;
                                        <a href="/ekle-urun-kategori/sil-urunKategori/{{ $urunKategorisi->id }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
