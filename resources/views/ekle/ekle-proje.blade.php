            ...
            <div class="portlet light form-fit bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">Proje Ekle</span>
                    </div>
                </div>
                    ...
                    <form method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-3">Proje Adı</label>
                                <div class="col-md-4">
                                    <input name="ad" class="form-control" id="mask_date" required type="text"/>
                                    <span class="help-block"> Proje isimlendirmesini yazınız </span>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Müşteriler</label>
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select name="musteri_id" id="single" class="form-control select2">
                                                <option></option>
                                                @foreach($cekilenMusteriler as $musteri)
                                ...
                                <span class="help-block"> Projenin Hangi Müşteriye Ait Olduğunu Seçiniz </span>
                            </div>
                        </div>
            ...
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">Eklenen Projeler</span>
                        @if(session('status'))
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            <tbody>
                            @foreach($cekilenProjeler as $proje)
                                <tr>
                                    <td> {{$proje->id}}</td>
                                    <td> {{ $proje->ad }}</td>
                                    <td> {{ $proje->musteri->unvan }}</td>
                                    <td> {{ $proje->updated_at }}</td>
                                    <td>
                                        <a href="/ekle-urun-kategori/guncelle-urun-kategori/{{ $proje->id }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>&nbsp;/ &nbsp;
                                        <a href="/ekle-urun-kategori/sil-urunKategori/{{ $proje->id }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
